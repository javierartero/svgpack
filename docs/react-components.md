...
- Use `SvgpackMask` for icons that should inherit color from `currentColor`.
- Use `SvgpackBackground` for logos or multicolor SVG assets.
- Use plain classes from [CSS Variables](/css-variables/) if you do not need a React wrapper.
- Use [Tailwind v4](/tailwind-v4/) if your project already maps everything through Tailwind utilities.
